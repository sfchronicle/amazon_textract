districts = {
  ...
  "SCH": {
    "doc_type":['Report - Incident Involving Therapeutic Physical Restraint',
                "HEALTH OFFICE",
                "Summary Report of De-Escalation and Restraint Use",
                "PHYSICAL RESTRAINT REPORT"],
    "incident_date": ["Date of incident:",
                      "of Incident:",
                      "Henrthy Date of Incident:",
                      "Date:"],
    ...
    "description": ["interventions used preceding the restraint).",
                    ...
                    "de-escalation techniques.and/or restraints:",
  ...
  "BETH": {
    ...
    'duration': ['Complete Time of Restraint'],
    "description": ["interventions used preceding the restraint)."],
    "injury": ["Assessment of Student:",
              "To the Stduent(nature of injury):"]
  },
